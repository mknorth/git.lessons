...
public class GetRequestExample {
    ...
    public void userAgentTest() throws IOException {
        client = new OkHttpClient.Builder()
                .addInterceptor((Interceptor) new UserAgentInterceptor("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36"))
                .build();
